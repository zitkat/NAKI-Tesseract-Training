...
"""
Convex hulls generation w/o backgroung map
...
#vygenerovani konvexnich obalu pro trenovani neuronove site, bez mapy pro pozadi
import h5py
import os
import cv2
import pickle
...
img_lst.sort()
pickle_lst.sort()
output_path = "//147.228.125.178/home/h5py_convex/"
...
f_out = h5py.File(output_path + "maps_convex2.h5", 'w')
